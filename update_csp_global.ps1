$paths = @(
    "c:\Users\marou\OneDrive - ROC Alfa-college\Bureaublad\BELANGRIJJK C#\tutorial\*.html",
    "c:\Users\marou\OneDrive - ROC Alfa-college\Bureaublad\BELANGRIJJK C#\projects\*.html"
)
